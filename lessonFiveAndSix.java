...
public class lessonFiveAndSix {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("выбор действия: Введите (add) добавить данные, Введите (del) удалить данные, Введите (num) найти номера по фамилии, Введите (sur) найти фамилию, " +
                "Введите (save) сохранить, Введите (exit) выход");
